...
uint16_t arrival_taskA_counter = 0;
...
uint32_t arrival_taskA_time = 1000; // threshold of counter in ms


uint32_t arrival_task0_time = 10; // threshold of counter in ms
uint32_t revival_task0_time = 1000;

uint32_t arrival_task1_time = 49;
uint32_t revival_task1_time = 700;

uint32_t arrival_task2_time = 137;
uint32_t revival_task2_time = 1000;

uint32_t arrival_task3_time = 18;
uint32_t revival_task3_time = 1000;


uint8_t arrival_taskA_flag = 0;
...
{
	// System Task
	arrival_taskA_counter++;
	if(arrival_taskA_counter == arrival_taskA_time)
	{
		arrival_taskA_counter = 0;
		arrival_taskA_flag = 1;
	}
...
void time_init(void)
{
    PORTB->PCR[19] |= (1 << 8); // PORTB pin 19 in alt1 mode, is the green led on board
