...
uint32_t arrival_task0_time = 50; // threshold of counter in ms
uint32_t revival_task0_time = 1000;

uint32_t arrival_task1_time = 129;
uint32_t revival_task1_time = 100;

uint32_t arrival_task2_time = 77;
uint32_t revival_task2_time = 1000;

uint32_t arrival_task3_time = 38;
